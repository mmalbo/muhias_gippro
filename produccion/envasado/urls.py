...
urlpatterns = [
    ...
    path('solicitudes/<uuid:pk>/', views.detalle_solicitud_envasado, name='detalle_solicitud'),
    ...
    path('solicitudes/<uuid:pk>/registrar-lote/', views.registrar_lote_envasado, name='registrar_lote'),
