...
from . import views
from .views import MateriaPrimaAdquisicionListView, MateriaPrimaAdquisicionDetailView, MateriaPrimaAdquisicionWizard, \
    MateriaPrimaAdquisicionUpdateView, EnvaseAdquisicionListView, EnvaseAdquisicionDetailView, \
    EnvaseAdquisicionUpdateView, InsumosAdquisicionListView, InsumosAdquisicionDetailView, InsumosAdquisicionUpdateView

urlpatterns = [
    path('materia_prima_adquisicion/', MateriaPrimaAdquisicionListView.as_view(),
         name='materia_prima_adquisicion_list'),
    path('materia_prima_adquisicion/<uuid:pk>/', MateriaPrimaAdquisicionDetailView.as_view(),
         name='materia_prima_adquisicion_detail'),
    ...
    path('materia-prima/nueva/',
         MateriaPrimaAdquisicionWizard.as_view(),
         name='nueva_materia_prima_adquisicion'),

    path('adquisicion/<int:pk>/',
         views.adquisicion_detalle,
         name='adquisicion_detalle'),
    path('materia_prima_adquisicion/nuevo/', views.materia_add, name='materia_adquisicion_add'),
    path('materia_prima_adquisicion/update/<uuid:pk>/', MateriaPrimaAdquisicionUpdateView.as_view(),
         name='materia_prima_adquisicion_update'),
